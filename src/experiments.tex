...
We now dive into the performance of the HGCN model trained according to the experimental setup described in \Cref{sec:expsetup}. In \Cref{fig:hyperbolicSpace}
