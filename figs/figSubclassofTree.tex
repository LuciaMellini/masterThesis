\begin{figure}
    \centering
        ...
        child {node {\dots}};
    \end{tikzpicture}
    \caption{A subtree composed of \emph{Disease} type nodes linked by \emph{Subclassof} edges centered on the leaf disease \emph{cystic fibrosis associated meconium ileus} .}
